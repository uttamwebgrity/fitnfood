...
if(isset($_POST['enter']) && $_POST['enter']=="yes" && trim($_POST['login_form_id'])==$_SESSION['login_form_id']){
	...
	$sql="select id from users where id='". $_SESSION['user_id'] ."' and password='". $EncDec->encrypt_me(trim($_REQUEST['old_password'])) ."' and status=1 limit 1";
...
<div class="bodyContent">
  <div class="mainDiv2">
    ...
    <div class="my_account">     
      ...
      <form method="post" action="<?=$_SERVER['PHP_SELF']?>"  name="ff" onsubmit="return password_validate()">
        <input type="hidden" name="enter" value="yes" />     
         <input type="hidden" name="login_form_id" value="<?=$_SESSION['login_form_id']?>" />	
      <div class="my_account_left" style="width:100%;">      
