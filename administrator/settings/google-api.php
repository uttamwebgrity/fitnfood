...
if(isset($_POST['enter']) && $_POST['enter']=="yes"){
	...
	if(intval($error_found) == 0){
		...
		$data['developer_key']=trim($_REQUEST['developer_key']);
		
		$db->query_update("third_party_api",$data,"id=2");
		
		
		$_SESSION['google_id']=trim($_REQUEST['app_id']);
		$_SESSION['google_secret']=trim($_REQUEST['app_secret']);
		$_SESSION['google_developer_key']=trim($_REQUEST['developer_key']);			
		
		if($db->affected_rows > 0)
			$_SESSION['msg']="Google API details successfully updated!";	
	}
...
$sql="select * from third_party_api where id=2 limit 1";
...
if(count($result) == 1){
	...
	$developer_key=$result[0]['developer_key'];
...
function validate(){
	...
	if(!validate_text(document.ff.developer_key,1,"DEVELOPER KEY should not be blank"))
		return false;	
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
    ...
    <td align="left" valign="top"><table border="0" align="left" cellpadding="0" cellspacing="0">
        <tr>
          ...
          <td align="left" valign="middle" class="body_tab-middilebg">Google API</td>
        ...
        <table width="95%" border="0" align="center" cellpadding="0" cellspacing="0">
          ...
          <tr>
            <td align="left" valign="top" colspan="3"><table width="90%" border="0"  align="center" cellspacing="2" cellpadding="6">
                ...
                <tr>
                  <td width="14%" class="body_content-form" valign="top">DEVELOPER KEY:<font class="form_required-field"> * </font></td>
                  <td width="86%" valign="top"><input name="developer_key" value="<?=$developer_key?>" type="text" autocomplete="off" class="form_inputbox"  size="40"/></td>
                </tr>
                <tr>
