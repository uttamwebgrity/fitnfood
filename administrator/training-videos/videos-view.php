            ...
            <td width="780" align="left" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="10">
                ...
                <tr>
                 ...
                 <tr>
              	...
              	<script type="text/javascript" src="<?=$general_func->site_url?>jwplayer.js"></script>
                <script type="text/javascript">
             		jwplayer("mediaplayer").setup({
                    	flashplayer: "<?=$general_func->site_url?>player.swf",
                        file: "http://fitnfood.com.au/video_files/<?=trim($result[0]['video_code'])?>",
                        image: "<?=$general_func->site_url?>video_js/myPoster.png"
                    });
                </script>
