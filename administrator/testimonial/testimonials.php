...
if(isset($_GET['action']) && $_GET['action']=='delete'){	
	...
	$db->query_delete("testimonials","id='".$_REQUEST['id'] ."'");
	$_SESSION['msg']="Your selected testimonial deleted!";
...
function del(id,url,performance){
	var a=confirm("Are you sure, you want to delete testimonial: '" + performance +"'?")
    if (a){
  ...
  <tr>
    <td align="left" valign="top"><table border="0" align="left" cellpadding="0" cellspacing="0">
        <tr>
          ...
          <td align="left" valign="middle" class="body_tab-middilebg">Testimonials</td>
  ...
  <tr>
    <td align="left" valign="top" class="body_whitebg"><table width="100%" border="0" cellspacing="0" cellpadding="0">
        ...
        <?php
				...
				$sql="select * from testimonials $query order by $order_by";
...
cellpadding="5" cellspacing="1">
              <tr>
                <td  class="text_numbering">
                    ...
                    <tr>
                      <td width="5" align="left" valign="top"><img src="images/button-curve-left.png" alt="" width="5" height="22" /></td>
                      <td align="left" valign="middle" class="body_tab-middilebg"><input name="button" type="button" class="submit1" value="Add New" onclick="location.href='<?=$general_func->admin_url?>testimonial/testimonials-new.php'" /></td>
                      <td width="5" align="right" valign="top"><img src="images/button-curve-right.png" alt="" width="5" height="22" /></td>
                    </tr>
                  </table>
                ...
                <td class="text_numbering" align="right" colspan="2"><?=$total_count?>
                  testimonials found.</td>
              </tr>
              <tr>
               	<td width="25%" align="left" valign="middle" bgcolor="#35619c" class="table_heading"><a href="testimonial/testimonials.php?display_oder=title&display_oder_type=<?=$display_oder_type?>" class="header_link">Name</a></td>
              ...
              <tr>
                <td colspan="3" align="center" bgcolor="#f5f7fa" valign="middle" height="50" class="message_error">Sorry, no testimonials found</td>
              </tr>
              <?php }else{
              ...
              <tr bgcolor="<?=$j%2==0?$general_func->color2:$general_func->color1;?>">
                <td  align="left" valign="middle" class="table_content-blue"><?=$result[$j]['name']?></td>              
                 <td  align="left" valign="middle" class="table_content-blue"><?=$result[$j]['details']?></td>           
               
                <td align="center" valign="middle" class="table_content-blue"><img src="images/edit.png" onclick="location.href='<?=$general_func->admin_url?>testimonial/testimonials-new.php?id=<?=$result[$j]['id']?>&action=EDIT&return_url=<?=urlencode($url)?>'" style="cursor:pointer;" />&nbsp;&nbsp;&nbsp;&nbsp; 
                <img src="images/view-details.png" onclick="location.href='<?=$general_func->admin_url?>testimonial/testimonial-view.php?id=<?=$result[$j]['id']?>&action=VIEW&return_url=<?=urlencode($url)?>'" style="cursor:pointer;"  title="VIEW" alt="VIEW" /> &nbsp;&nbsp;&nbsp;&nbsp;             
                <img src="images/delete.png" onclick="del('<?=$result[$j]['id']?>','<?=urlencode($url)?>','<?=addslashes($result[$j]['name'])?>')" style="cursor:pointer;" /> </td>
              </tr>
              <?php }
				}
	  		?>
