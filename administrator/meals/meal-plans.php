...
if(isset($_GET['action']) && $_GET['action']=='delete'){
	...
	$order_meals_found=$db->num_rows("select id from order_meals where meal_plan_id='".$_REQUEST['id'] ."'  limit 1");
	
	
	if($order_meals_found == 0 ){
		...
		$meassage="Your selected meal plan can not be deleted as some orders has been placed for it!";
  ...
  <tr>
    <td align="left" valign="top" class="body_whitebg"><table width="100%" border="0" cellspacing="0" cellpadding="0">
        ...
        <?php
			...
			?>
        <tr>
          <td align="left" valign="top"><table width="980" align="center" border="0" 
cellpadding="5" cellspacing="1">
              <tr>
                <td  class="text_numbering" colspan="2">
                  ...
                  <td > </td>
                <td class="text_numbering" colspan="7" align="right"><?=$total_count?>
              ...
              <tr>
                ...
                <a href="meals/meal-plans.php?display_oder=name&display_oder_type=<?=$display_oder_type?>" class="header_link">Plan Name</a></td>
   				<td width="100"  align="center" valign="middle" class="table_heading">Meal Plan Link</td>
   				<td width="70"  align="center" valign="middle" class="table_heading"># of Days</td>
   				<td width="70"  align="center" valign="middle" class="table_heading">Meal/Day </td>
   				<td width="70"  align="center" valign="middle" class="table_heading">Snack/Day </td>
   				<td width="90"  align="center" valign="middle" class="table_heading">
              ...
              <tr>
                <td colspan="9" align="center" bgcolor="#f5f7fa" valign="middle" height="50" class="message_error">Sorry, no meal plans  found!</td>
              </tr>
              <?php }else{
					for($j=0;$j<count($result);$j++){
						$meal_exists=$db->num_rows("select id from meal_plan_meals where meal_plan_id='". $result[$j]['id'] ."' limit 1");
              ...
              <tr bgcolor="<?=$j%2==0?$general_func->color2:$general_func->color1;?>">
                ...
                <td align="left" valign="middle" class="table_content-blue">
                	<?php if($meal_exists == 1){?> 
                		<input type="text" name="cd"  onclick="this.focus();this.select()" value="<?=$general_func->site_url?>meal-plan/<?=$result[$j]['id']?>/<?=$result[$j]['meal_plan_category_id']?>/"  autocomplete="OFF" size="25" class="inputbox_employee-listing" />
					 <?php }   ?>          	
				...
				<td align="center" valign="middle" class="table_content-blue">
					<a  href="<?=$general_func->admin_url?>meals/meal-plans-meal.php?id=<?=$result[$j]['id']?>&name=<?=urlencode($result[$j]['name'])?>&action=mealplanmeal"><img src="images/icons/<?=$meal_exists==1?'dsbdIco_green':'dsbdIco9_light';?>.png" /></a>
				</td>               
