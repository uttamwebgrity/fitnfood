	...
	<tr>
		...
		<table border="0" align="left" cellpadding="0" cellspacing="0">
			<tr>
				...
				<td align="left" valign="middle" class="body_tab-middilebg">Last Week Order/Payments</td>
	...
	<tr>
		...
		<table width="100%" border="0" cellspacing="0" cellpadding="0">
			...
			if (isset($_REQUEST['display_oder']) && trim($_REQUEST['display_oder']) != NULL) {
			 ...
			 $first_date_of_the_search_week = date("Y-m-d",strtotime(date("Y-m-d",strtotime('monday this week'))) - (86400 * 7));	
			$last_date_of_the_search_week = date("Y-m-d",strtotime(date("Y-m-d",strtotime('sunday this week'))) - (86400 * 7));					
